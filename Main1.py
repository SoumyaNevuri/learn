...
def graph():
    ...
    df.pivot("Performance Output", "Algorithms", "Value").plot(kind='bar')
    plt.show()
...
adaboostButton1 = Button(main, text="Run AdaBoost Algorithm", command=runAdaBoost)
adaboostButton1.place(x=630,y=650)
adaboostButton1.config(font=font1)
